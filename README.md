...
1. How would you describe acessibility on the web to someone new to programming?
    ...
    Semantic html elements, and media quiries in css

2. Talk about 3 different things you can do to ensure your website is accessible. 

    use alternative text for images; use media quiries in css, use a css reset page to format for most/ all browsers.

3. How would you explain the concept of a variable to someone new to programming?

    a variable will store data that can be called for use later in the code.

4. What is the purpose of using functions in code?

    functions are use to execute a block of code as many times as you want.
